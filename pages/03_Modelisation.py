...
if selected_view == "Architecture":
    ...
    if selected_view2 == "Résumé":
        ...
        view2.image(f"images/{selected_model}/summary_initial.png",use_column_width=True)
        ...
        view3.image(f"images/{selected_model}/summary_ft.png",use_column_width=True)  
        ...
        if selected_model == "VGG16":
            ...
            vgg3.image(f"images/{selected_model}/arch.png",use_column_width=True)
        else:
            select_title2.image(f"images/{selected_model}/arch.png",use_column_width=True)
...
# Selected "Entraînement"
    ...
    if selected_view2 == "Sans fine-tuning":
        ...
        select_title2.image(f"images/{selected_model}/fit_1_10.png",use_column_width=True)
        ...
        select_title2.image(f"images/{selected_model}/fit_11_20.png",use_column_width=True)
...
# Selected "Résultats"
    ...
    if selected_view2 == "Courbe d'apprentissage":
        ...
        select_title2.image(f"images/{selected_model}/acc_loss_plot.png",use_column_width=True)
        ...
        select_title2.image(f"images/{selected_model}/cm_heatmap.png",use_column_width=True)
        ...
        select_title2.image(f"images/{selected_model}/cr.png",use_column_width=True)
