...
Il ne reste plus qu’à récupérer le masque binaire pour isoler la cellule.
    ...
    with Image.open("images/segm_couleur.png") as img:
        title_2.image(img,use_column_width=True,caption="Exemple des étapes de ségmentation")
    ...
    with Image.open("images/MY_507649.jpg") as img:
        img2.image(img,use_column_width=True,caption = "Image originale (MY_507649.jpg)")   
    with Image.open("images/comp.png") as img:
        img3.image(img,use_column_width=True, caption = "Image ségmentée par computer vision")   
...
Il ne reste plus qu’à récupérer le masque binaire pour isoler la cellule.""")
    with Image.open("images/unet_architecture.png") as img:
        title_2.image(img,use_column_width=True,caption = "Architecture du réseau U-Net")
    title_2.markdown("<p style='padding: 10px; border: 2px solid white;text-align: center;font-size: 20px;'>Résultat</p>", unsafe_allow_html=True)
    img1,img2,img3,img4 = st.columns([2,1,1,2])
    with Image.open("images/MY_507649.jpg") as img:
        img2.image(img,use_column_width=True,caption = "Image originale (MY_507649.jpg)")   
    with Image.open("images/deep.png") as img:
        img3.image(img,use_column_width=True, caption = "Image ségmentée par deep learning")   
